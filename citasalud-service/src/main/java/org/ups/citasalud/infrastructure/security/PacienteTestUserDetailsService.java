 ...
 * Las contraseñas se codifican con el mismo {@link PasswordEncoder} delegante que valida el login
 * (bcrypt por defecto), en vez de almacenarse en texto plano con el prefijo {@code {noop}}.
 */
@Service
public class PacienteTestUserDetailsService implements UserDetailsService {

    private final Map<String, PacienteUserDetails> pacientes;

    public PacienteTestUserDetailsService(PasswordEncoder passwordEncoder) {
        this.pacientes = Map.of(
                "paciente1", new PacienteUserDetails(
                        ...
                        "+593987654321",
                        "paciente1",
                        passwordEncoder.encode("paciente1")),
                "paciente2", new PacienteUserDetails(
                        ...
                        "+593987654322",
                        "paciente2",
                        passwordEncoder.encode("paciente2"))
        );
    }
